...
TEST(
    AltitudePdControllerTest,
    ZeroErrorAndZeroSpeedProducesHoverThrust) {
...
TEST(
    AltitudePdControllerTest,
    ClampsThrustToUpperAndLowerLimits) {
    const AltitudePdController controller{makeDefaultParameters()};
...
TEST(
    ...
    EXPECT_THROW(
        controller.compute(1.0, 1.0, infinity),
        std::invalid_argument);
}
